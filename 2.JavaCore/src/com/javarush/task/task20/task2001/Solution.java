...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("d:\\1\\tmp1", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (assets != null) writer.println(assets.size());
            for (Asset x : assets) {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if ("yes".equals(isAssetsPresent)) {
                ...
                for (int i=0; i<s; i++) {
                    tAsset = new Asset(reader.readLine());
                    tAsset.setPrice(Double.parseDouble(reader.readLine()));
                    assets.add(tAsset);
                }
            }
